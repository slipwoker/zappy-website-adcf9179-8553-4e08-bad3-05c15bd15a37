document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validators = {
      ...
      tel: function (value) {
        return value.trim() === '' || /^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/.test(value.trim());
      },
    ...
    const showFormSuccess = function () {
      ...
      const errorEl = contactForm.querySelector('.form-submit-error');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'adcf9179-8553-4e08-bad3-05c15bd15a37',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'adcf9179-8553-4e08-bad3-05c15bd15a37';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'adcf9179-8553-4e08-bad3-05c15bd15a37';
